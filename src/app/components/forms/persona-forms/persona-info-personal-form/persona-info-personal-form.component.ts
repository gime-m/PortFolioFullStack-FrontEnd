...
@Component({
  selector: 'app-persona-info-personal-form',
  templateUrl: './persona-info-personal-form.component.html',
  styleUrls: ['../../../../styles/editing.styles.css']
})
export class PersonaInfoPersonalFormComponent extends BaseFormPersonaComponent implements OnInit {
